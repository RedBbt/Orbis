...
1. **Die 20 Nicht-OK-Tests gehen auf nur 9 unterschiedliche Probleme zurück** (L-01…L-05, L-08, K-04, K-05, U-02, U-03, W-01 — mehrere Tests prüfen dasselbe Problem in verschiedenen Kasus). Kein einziges Problem ist ein Widerspruch im morphologischen Kern: **Kongruenz, Deklination (alle 45 Endungen + Kernwörter), Konjugation (6×3 + alle 8 unregelmäßigen), V2, Verbklammer im Hauptsatz, Negation, Passivbildung und Phonotaktik der Testsätze halten in allen 130 bildbaren Sätzen** — maschinell bestätigt (Validator-Bericht, Lauf D: 0 automatische Befunde).
2. Zusätzlich zu den 9 korpuswirksamen Problemen dokumentieren Audit und Berichte **21 weitere Befunde** (K-01…K-03, L-06, L-07, L-09, L-10, U-01, U-04…U-14), die keine Testsätze scheitern lassen, aber vor 1.0 entschieden oder redigiert werden sollten. Gesamtinventar: **30 Befunde + Phase-7-Wortschatzliste.**
...
2. **Der morphologische Kern ist widerspruchsfrei.** Alle 45 Endungen, alle Kasus, beide Pluralsysteme, alle 8 unregelmäßigen Verben, Artikel- und Adjektivkongruenz: 0 Fehler in 130 Sätzen + 270 Testformen. Die einzigen echten Regelkonflikte (K-01…K-05) sind Dokumentations- bzw. Endfeld-Probleme, kein struktureller Umbaubedarf.
