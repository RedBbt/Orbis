...
**kurz** — kurz. Attributiv dekliniert (Stamm + r/l/n + a + Marker), praedikativ in der Grundform (§12.1–§12.2); Adverb auf -un (§12.4). (Migrierte Woerterbuchglosse aus §24.7; ausformulierte Definition steht aus.)
...
- Komparativ (prädikativ): **misnvi**
- Superlativ (prädikativ): **misnvax**
...
- Konzept(e): `ORB-CON-000114`
- antonym: `ORB-LEX-000113` — Gegensatzpaar aus dem Adjektivbestand §24.7.
