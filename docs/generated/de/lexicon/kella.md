...
**welch- (F)** — welch- (F). Kongruiert adjektivisch (Beispiel §18.2: Kellan sarlan milkoş?). Die Form verletzt die Fugenregel (K-02). (Migrierte Woerterbuchglosse aus §18.2; ausformulierte Definition steht aus.)

| Feld | Wert |
|---|---|
| ID | `ORB-LEX-000160` |
| Wortart | pronomen (fragewort-adjektivisch) |
| Status | canonical |
| Häufigkeit | UNRATED |
| Domäne | grammatik |
| Quelle | §18.2 |
...
- Phonemfolge: k · e · l · l · a
- Silbifizierung: **mehrdeutig** (kel·la, kell·a) — Befund L-09
- Phonotaktik: ok
...
- Offene Befunde:
  - **K-02** — Pronomenformen verletzen die Fugenregel
