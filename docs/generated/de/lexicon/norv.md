...
**falsch** — falsch. Attributiv dekliniert (Stamm + r/l/n + a + Marker), praedikativ in der Grundform (§12.1–§12.2); Adverb auf -un (§12.4). (Migrierte Woerterbuchglosse aus §24.7; ausformulierte Definition steht aus.)
...
- Komparativ (prädikativ): **norvi**
- Superlativ (prädikativ): **norvax**
...
- Konzept(e): `ORB-CON-000124`
- antonym: `ORB-LEX-000123` — Gegensatzpaar aus dem Adjektivbestand §24.7.
