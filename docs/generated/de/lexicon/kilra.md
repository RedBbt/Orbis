...
**dieser(m)** — dieser(m). Nur die Grundform ist belegt; die Deklination ist nicht definiert (L-06). (Migrierte Woerterbuchglosse aus §13.4; ausformulierte Definition steht aus.)
...
- Phonemfolge: k · i · l · r · a
- Silbifizierung: **mehrdeutig** (kil·ra, kilr·a) — Befund L-09
- Phonotaktik: ok
