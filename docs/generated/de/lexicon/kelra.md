...
**welch- (M)** — welch- (M). Kongruiert adjektivisch (Beispiel §18.2: Kellan sarlan milkoş?). (Migrierte Woerterbuchglosse aus §18.2; ausformulierte Definition steht aus.)
...
- Phonemfolge: k · e · l · r · a
- Silbifizierung: **mehrdeutig** (kel·ra, kelr·a) — Befund L-09
- Phonotaktik: ok
