...
**gut** — gut. Attributiv dekliniert (Stamm + r/l/n + a + Marker), praedikativ in der Grundform (§12.1–§12.2); Adverb auf -un (§12.4). (Migrierte Woerterbuchglosse aus §24.7; ausformulierte Definition steht aus.)
...
- Komparativ (prädikativ): **selvi**
- Superlativ (prädikativ): **selvax**
...
- Konzept(e): `ORB-CON-000108`
- antonym: `ORB-LEX-000109` — Gegensatzpaar aus dem Adjektivbestand §24.7.
